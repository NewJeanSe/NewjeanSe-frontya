...
const OCRDataBaseHeaderBar: React.FC<{
	...
	const handleBackClick = () => {
		router.push('/userDataBaseMain'); // 항상 '/userDataBaseMain' 페이지로 이동
	};
	...
	return (
		<div className={styles.headerBar}>
			...
			<div className={styles.headerButtons}>
				<button className={styles.headerButton} onClick={handleBackClick}>
					<Image
...
export default OCRDataBaseHeaderBar;
